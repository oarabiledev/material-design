...
privateFolder = app.GetPrivateFolder("Plugins") + "/material-design/";
...
function drawMediumAppBar(title, leadingIcon, controlIcons, parentLay) {
    ...
    function drawTwoControls() {
        ...
        controlA.SetPosition(
            DW() - (dpToPxConversion(16) + dpToPxConversion(46)),
            dpToPxConversion(20),
            null,
            null,
            "px",
        ...
        controlB.SetPosition(
            DW() - (dpToPxConversion(72) + dpToPxConversion(46)),
            dpToPxConversion(20),
            null,
            null,
            "px",
    ...
    function drawThreeControls() {
        ...
        controlC.SetPosition(
            DW() - (dpToPxConversion(136) + dpToPxConversion(46)),
            dpToPxConversion(20),
            null,
            null,
            "px",
