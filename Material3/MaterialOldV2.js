...
app.Script(_path + 'uxElements/m3Navigation.js'); 
app.Script(_path + 'uxElements/m3Switches.js'); 
app.Script(_path + 'uxElements/m3Progress.js'); 
app.Script(_path + 'uxElements/m3SnackBar.js'); 
app.Script(_path + 'uxElements/m3Buttons.js'); 
app.Script(_path + 'uxElements/m3Dialog.js'); 
app.Script(_path + 'uxElements/m3Search.js'); 
app.Script(_path + 'uxElements/m3Text.js'); 
...
app.CreateMaterial3 = function(defaultTheme,defaultIconFill,defaultThemeDir) {
        return new Material3(defaultTheme,defaultIconFill,defaultThemeDir)
    }
    ...
    constructor(defaultTheme,defaultIconFill,defaultThemeDir) { 
        ...
        */ 
        ...
        if(defaultThemeDir === 'default' || defaultThemeDir === 'dflt'){ 
            m3ColorSystem = _path + 'uxDesign/appTheme.json'; 
        } 
        else{ 
...
const ui = {};
Object.assign(ui, new Material3());
ui3 = new Material3()
