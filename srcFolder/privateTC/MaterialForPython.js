...
*/
$module.InitializeMaterialPlugin = function(baseTheme, iconFill) {
...
app.CreateMaterial3 = (baseTheme, iconFill) => {
    $module.InitializeMaterialPlugin(baseTheme, iconFill);
    warnDeveloper(ErrorCodes["301"]+`
    \nUse $module.InitializeMaterialPlugin()`);
}
...
$module.createLayout = function(type, options, width, height, parentLay) {
...
$module.addFilledButton = function (btnName, width, height, icon, parentLay) {
 ...
 * @param {object} parentLay - parent For Button
*/
$module.addElevatedButton =  function (btnName, width, height, icon, parentLay) {
 ...
 * @param {object} parentLay - parent For Button
*/
$module.addFilledTonalButton = function (btnName, width, height, icon, parentLay) {
 ...
 * @param {object} parentLay - parent For Button
*/
$module.addOutlinedButton = function (btnName, width, height, icon, parentLay) {
 ...
 * @param {object} parentLay - parent For Button
*/   
$module.addTextButton = function (btnName, width, height, icon, parentLay) {
...
*/ 
$module.addSmallFAB = function (icon, layout) {
 ...
 * @param {object} layout - parent For Component
*/ 
$module.addFAB = function (icon, layout) {
 ...
 * @param {object} layout - parent For Component
*/ 
$module.addLargeFAB = function (icon, layout) {
    return new largeFABObject(icon, layout);
}
    
$module.addChip = function (type, text, icon, width, height, parentLay) {
 ...
 * @param {number} width - Width in DroidScript Scale 0 -1
*/
$module.addSnackBar = function (text, btnAction, width, alignment) {
...
*/ 
$module.addProgressBar = function (progressType, width, layout) {
...
*/
$module.addAlignedAppBar = function (title, leadingIcon, controlIcons, parentLay) {
...
/**
    ...
    * @param {object} parentLay - ParentLayout For AppBar
*/
$module.addSmallAppBar = function(title, leadingIcon, controlIcons, parentLay){
...
/**
    ...
    * @param {object} parentLay - ParentLayout For AppBar
*/
$module.addMediumAppBar = function(title, leadingIcon, controlIcons, parentLay){
...
$module.addBottomAppBar = function (barPropsInjson, parentLayout) {
...
*/
$module.addSearchBar = function(leadingIcon, trailingIcon, hint, width, parentLayout){
...
*/
$module.addTabs = function(listOfTabs,width, height, options, parentLay){
...
*/
$module.addBottomSheet = function(sheetLayout, height, options){
...
*/
$module.addSwitch = function (switchType, value, parentLayout) {
...
*/
$module.addSwitchSettings = function(listOfSettings, switchValues, width, height, parentLay){
    return new 
 ...
 * @param {object} parentLay - Parent For Component
*/
$module.addContinuousSlider = function(value, width, parentLay){
 ...
 * @param {object} parentLay - Parent For Component
*/
$module.addCheckBoxList = function(list, checkDefinitions, width, height, parentLay){
...
function drawCheckBoxList(list, checkDefinitions, width, height, parentLay){
    ...
    checkbox = $module.createLayout('Linear',null,width,height,parentLay);
    
    /* Just A Simple Template */
    singleCheckList = function(item, checkDefinition){
        let singleCheckLay = $module.createLayout('Linear',null,width,height,checkbox)
...
function drawSwitchSettings(listOfSettings, switchValues, width, height, parentLay){
    ...
    let __SwitchTemplate = function (headerValue, descriptionValue, boolSwitchValue){
        __layout = $module.createLayout('Linear','Left,Horizontal',-1,-1,__SwicthListContainer)
        ...
        _cardLayout = $module.addSwitch('noIcon',true,__layout);
...
function drawMediumAppBar(title, leadingIcon, controlIcons, parentLay){
    ...
    mediumBar = $module.createLayout('Linear','Vertical');
    ...
    contentContainer = $module.createLayout('Linear',null,null,null);
...
function drawSecondaryTabs(listOfTabs, width, height, options, parentLay){
    ...
    if (__tabCount == 2){
        ...
        __firstTabLay = $module.createLayout(layoutType, options, width, 
        height - dpToDsUnit(48,'h'), __secondaryLayJacket)
        
        __secondTabLay = $module.createLayout(layoutType, options, width,
        height - dpToDsUnit(48,'h'), __secondaryLayJacket)
    ...
    lightBarClr.subscribe((value)=>{
        ...
        __thirdTabLay = $module.createLayout(layoutType, options, width,
        height - dpToDsUnit(48,'h'), __secondaryLayJacket)
