...
/** $module Material3, basically reads your baseTheme.json File
*/
$module.$moduleMaterialPlugin = function() {
    ...
    is$moduled.value = true;
}

/** $module Material3, basically reads your baseTheme.json File. Also Old.
*/
app.CreateMaterial3 = () => {
    $module.$moduleMaterialPlugin();
    warnDeveloper(ErrorCodes["301"]+`
    \nUse $module.$moduleMaterialPlugin()`);
}
...
/**Experimental Api - B$moduleldFromForm
*/

$module.readFromForm = function(){
    
}

/*Experimental Api - B$moduleld Hybrid Apps using Euphoria 
  Framework.
...
*/
$module.mixWithEuphoria = function(appProps){
...
is$moduled = createSignal();

is$moduled.value = false;
